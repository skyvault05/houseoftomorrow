...
<div class="estimateDetail-main-wrap">
	<div class="container pt-5">
		<div class="estimateBoard"><!--start 견적게시판-->
			...
			<div type="hidden" name="noticeNo" value="${notice.noticeNo}"></div>    <table class="table">
                    <thead>
                        <tr class="row">
                            <th class="col-sm-12">${notice.noticeTitle}</th>
                    ...
                    <tbody>
                        ...
                        <tr class="row">
                            <td class="text-center col-sm-12">${notice.noticeDescription}</td>
                          
                                
                            </td>
                        </tr>
                        <tr class="row">
                        	<td class="text-center col-sm-8"></td>
