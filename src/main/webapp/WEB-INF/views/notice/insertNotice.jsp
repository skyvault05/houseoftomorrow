...
<div class="expert-user-form__form-group__input"><textarea style="min-height: 120px; height: 135.4px;" placeholder="공지할 내용을 입력하세요" class="form-control text-area-input" name="noticeDescription" id="noticeDescription">
</textarea>
</div>
</div>
<div class="row">
<div width="450" height="20" align="center"><b><span style="font-size:9pt;">
		<input type="submit" value="등록하기"> <input type="reset" value="다시쓰기"></span></b></div>
</div>
</div>
</form>
