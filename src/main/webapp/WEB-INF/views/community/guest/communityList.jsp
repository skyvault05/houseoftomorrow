...
<div class="row" style="transform:translateX(-0px)"><br><br>
                <c:forEach items="${requestScope.list}" var="list" varStatus="status">
                   <div class="col-md-3">
                   <div style="relative">
                        <a href="${pageContext.request.contextPath}/community/detail/${list.commNo}"><img src="${list.commImg}" class="card-img-top rounded" alt="blog" width="255px" height="255px"></a>
                        <a href="${pageContext.request.contextPath}/community/detail/${list.commNo}">
                          <p class="card-text title" style="font-size: 20px; margin-left: 10px;">${list.commTitle}</p>
