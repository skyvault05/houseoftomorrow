		...
		<div class="col-md-12 order-md-1">
			<form class="needs-validation" novalidate action="/manage/member/memberUpdate" method="POST">
				...
				<div class="mb-3">
					...
					<input type="password" class="form-control" id="currentPassword" placeholder="현재 비밀번호" value="" required name="currentPassword">
				</div>
				
				<div class="mb-3">
					<label for="username">이름</label> 
					<input type="text" class="form-control" id="username" placeholder="이름" required name="memberName">
				</div>

				<div class="mb-3">
					<label for="password">새 비밀번호</label> 
					<input type="password" class="form-control" id="password" placeholder="새 비밀번호" value="" required name="memberPwd">
				</div>


				<div class="mb-3">
					<label for="password">새 비밀번호 확인</label> 
					<input type="password" class="form-control" id="passwordCheck" placeholder="새 비밀번호 확인" value="" required name="memberPwdCheck"> 
				...
				<div class="mb-3">
					...
					<input class="btn btn-primary" type="button" id="phoneCheck" value="인증하기">
				</div>
				...
				<hr class="mb-4">
				<button class="btn btn-primary btn-lg btn-block" id="signupBtn" type="submit">회원 정보 수정</button>
				<hr class="mb-4">
			</form>
		</div>
	</div>
