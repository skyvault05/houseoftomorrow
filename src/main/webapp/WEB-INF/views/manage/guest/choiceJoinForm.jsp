	...
	<div class="expert-calculate__main row">
		...
		<section class="expert-calculate__content" style="margin: 0 auto;">
				<div class="expert-calculate__content__header">
					<h3 class="expert-calculate__content__header__title">회원가입</h3>
					<div class="alert alert-success alert-dismissible" role="alert">
					  <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
					  <strong>회원가입선택!</strong> 일반회원가입과 시공사회원가입 중 원하는 가입을 선택하여 주세요.
					</div>
				</div>
...
<div class="col-xs-12 col-sm-6 ">		
	<a class="btn btn-primary btn-block" style="font-size:20px" href="/memberSignup" >일반회원</a>	
</div>	
<div class="col-xs-12 col-sm-6 ">		
	<a class="btn btn-primary  btn-block" style="font-size:20px" href="/constructorSignup" >시공사</a>	
