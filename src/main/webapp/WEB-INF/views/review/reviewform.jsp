...
<script>
	...
	$(function(){
		$('a.reviewupdate').click(function(){
			...
			divhtml += '<div>평점: <input type="radio" id="star5" name="grade" value="5"  checked><input type="radio" id="star4" name="grade" value="4">';
	...
	<div class="expert-calculate__main row">
		...
		<section class="expert-calculate__content col-12 col-md-7 col-lg-8">
				<div class="expert-calculate__content__header">
					<h1 class="expert-calculate__content__header__title">시공 전문가 리뷰 쓰기</h1>
...
<div class="expert-user-form__form-group__input"><textarea style="min-height: 120px; height: 135.4px;" placeholder="처음 상담부터 친절하셨고, 작업도 꼼꼼하게 해주셨어요. 주변 사람들과 비교해보니 퀄리티 대비 가격도 합리적인 편이었습니다. 5개월 정도 지났는데 현재까지 하자는 없고, A/S도 약속해 주셔서 걱정 없이 지내고 있습니다. 주변에 엄청 추천하고 있어요!" class="form-control text-area-input">
</textarea>
</div>
</div>
</div>
...
<div>
<div class="expert-user-form__form-group">
<div class="expert-user-form__form-group__label"><h6>시공 사진</h6>
</div>
<div class="expert-user-form__form-group__description">시공 전/후 이미지 혹은 완성 이미지를 공유해주세요!</div>
<div class="expert-user-form__form-group__input">
...
<div class="expert-user-form__form-group">
<div class="expert-user-form__form-group__label"><h6>시공 계약서 추가</h6>
</div>
